...
Model DES lebih baik daripada model SES karena menghasilkan nilai MSE yang jauh lebih kecil pada dua skenario. Artinya, data testing tersebut cenderung memiliki tren sehingga \textit{Double Exponential Smoothing} lebih tepat dibandingkan \textit{Single Exponential Smoothing}
